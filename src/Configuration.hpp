...
struct Configuration
{
    ...
    std::map<std::string, std::vector<std::string> > targetRectTextMap = { {"en",{"photovoltaic_panels", "stripe_spot", "single_spot", "multi_spot"}}, {"zh", {"photovoltaic_panels", "stripe_spot", "single_spot", "multi_spot"}}};// 检测目标框顶部文字
